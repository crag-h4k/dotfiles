...
# home/.chezmoidata/palettes.yaml plus the palette picker list in
...
DEFAULT_OUT = os.path.join(REPO, "home", ".chezmoidata", "palettes.yaml")
DEFAULT_TOML = os.path.join(REPO, "home", ".chezmoi.toml.tmpl")
...
def emit_yaml(entries):
    out = []
    out.append("# home/.chezmoidata/palettes.yaml")
...
def main():
    ...
    ap.add_argument("--out", default=DEFAULT_OUT,
                    help="catalog to write (default: home/.chezmoidata/palettes.yaml)")
